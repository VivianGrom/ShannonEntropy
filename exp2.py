...
mskd_ent_matrix_stream, mskd_ent_matrix_hillslope, _, _ = entropy_calculator.calculate_shannon_entropy_mask(stream_mask = buffered_stream_mask)
...
# Save to NetCDF
ds.to_netcdf("/Users/viviangrom/Documents/papers/paper2_entropy/nc_files/exp2.nc")
